...
ngModule.directive('camera', function($templateCache, mediator, $window, $timeout) {
  return {
    ...
    controller: function($scope, $element) {
      ...
      var parentWidth = video.parentNode.offsetWidth;
      // var height = width / aspectRatio;
      var height = video.parentNode.parentNode.parentNode.parentNode.parentNode.parentNode.parentNode.offsetHeight;
